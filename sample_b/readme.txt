...
- ice_absorption : slope accounting for differences in ice optical absorption, nominal parameter values is 0, the uncertainty +/- 10 and the valid range +/- 15
- ice_scattering : slope accounting for differences in ice optical scattering, nominal parameter values is 0, the uncertainty +/- 10 and the valid range +/- 15
...
`f = df['offset']
    + df['ice_absorption']*value 
    + df['ice_scattering']*value
    + df['opt_eff_overall']*value
    + df['opt_eff_lateral']*value
