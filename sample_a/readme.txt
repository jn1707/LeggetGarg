...
`f = (df['offset'] 
      + df['ice_scattering']*(value - 1.0)
      + df['opt_eff_lateral']*(value - 25)
      + df['opt_eff_headon']*(value - 0)
      + df['ice_absorption']*(value - 1.0)
      + df['opt_eff_overall']*(value - 1.0)
      + df['coin_fraction']*(value - 0.0) )`
...
`f = (df['offset'] 
      ...
      + df['opt_eff_lateral']*(value - 25)
      + df['opt_eff_headon']*(value - 0)
      + df['ice_absorption'] * exp(df['ice_absorption_expslope']*(value-1.0)) - 1.0
      + df['opt_eff_overall'] * exp(df['opt_eff_overall_expslope']*(value-1.0)) - 1.0 )`
